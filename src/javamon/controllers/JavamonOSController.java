...
public class JavamonOSController {
    ...
    public void sendJavamon(Consoles ptarget, Javamon pjavamon){
        CommunicationManager comManager = new CommunicationManager();
        switch(ptarget){
            case next:
                comManager.SendJavamonToTargetConsole(pjavamon, Consoles.next);
                break;
            case classic:
                comManager.SendJavamonToTargetConsole(pjavamon, Consoles.classic);
                break;
        }
    }
