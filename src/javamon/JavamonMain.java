...
public class JavamonMain {
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (option !=3){
            ...
            System.out.println("3. Send it to NintengoNext");
            System.out.print("Enter String");
            option = Integer.parseInt(in.readLine());
            if (option == 1){
                System.out.print("Escriba el nombre del Javamon (y presione ENTER)? ");
                mainController.CreateJavamon(in.readLine());
            ...
            if (option == 2){
                ...
                mainController.sendJavamon(Consoles.classic, mainController.getJavamons().get(0));
                System.out.println("Javamon enviado," );
            }
            if(option == 3){
                System.out.println("Enviando el primer javamon de la lista");
                mainController.sendJavamon(Consoles.next, mainController.getJavamons().get(0));
                System.out.println("Javamon enviado,");
            }
        }
